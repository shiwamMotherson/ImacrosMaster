...
public class FMLAdvancedSFTPIteration1 {
    ...
    public static void main(String args[]) throws IOException {
 	   ...
 	   File directoryPath = new File("D:\\imacro\\"+imformat(Instant.now().toString()));

 	   FMLAdvancedSFTPIteration1 sftpFileTransfer=new FMLAdvancedSFTPIteration1();
