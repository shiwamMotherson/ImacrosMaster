...
import java.util.*;
public class ReconcillationAutomailer
{
 ...
 try
		{
	 		...
	 		ReconcillationAutomailer IMA= new ReconcillationAutomailer();
				...
				byte[] attachFileBytes		=	null;
					try
					{
						...
						while(rs.next())
						{
							...
							strAttachFileName= "ReconcilationReportDemo2.xls";
							...
							if(iTrials>=50)
							{
									...
									strMailFrom	 ="Mukesh.Prajapati@motherson.com";
									strMailTo		 ="Mukesh.Prajapati@motherson.com";
