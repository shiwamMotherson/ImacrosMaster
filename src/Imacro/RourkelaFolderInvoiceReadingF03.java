...
public class RourkelaFolderInvoiceReadingF03 {
	...
	static String UnitCode="F03";
	 public static void main(String args[]) throws IOException {
	  ...
	  sftpFileTransfer.createRootDirectory(directoryPath);
	   ...
	   public void ReadGS(){
		   File fileGS = new File("D:\\Raurkela("+UnitCode+")\\"+fileDate+"\\GS\\");
		   if(fileGS.exists()) {
		          ...
		          if(file.isFile()) {
		              ...
		              if(file.getName().substring(0,3).contains("TXA")) {
		              	...
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Raurkela("+UnitCode+")\\"+fileDate+"\\GS\\"+file.getName()),
	   ...
	   public void ReadBP(){
		   File fileGS = new File("D:\\Raurkela("+UnitCode+")\\"+fileDate+"\\BP\\");
		   if(fileGS.exists()) {
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              ...
		              if(file.getName().substring(0,3).contains("TXA")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Raurkela("+UnitCode+")\\"+fileDate+"\\BP\\"+file.getName()),
	   ...
	   public void ReadBS(){
		   File fileGS = new File("D:\\Raurkela("+UnitCode+")\\"+fileDate+"\\BS\\");
		   if(fileGS.exists()) {
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              ...
		              if(file.getName().substring(0,3).contains("INA")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Raurkela("+UnitCode+")\\"+fileDate+"\\BS\\"+file.getName()),
	   ...
	   public void ReadBSB(){
		   File fileGS1 = new File("D:\\Raurkela("+UnitCode+")\\"+fileDate+"\\BSB\\");
		   if(fileGS1.exists()){
			   File fileGS = new File("D:\\Raurkela("+UnitCode+")\\"+fileDate+"\\BSB\\");
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              ...
		              if(file.getName().substring(0,3).contains("BSA")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Raurkela("+UnitCode+")\\"+fileDate+"\\BSB\\"+file.getName()),
	   ...
	   public void ReadSSB(){
		   File fileGS = new File("D:\\Raurkela("+UnitCode+")\\"+fileDate+"\\SSB\\");
		   if(fileGS.exists()) {
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              ...
		              if(file.getName().substring(0,3).contains("SSA")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Raurkela("+UnitCode+")\\"+fileDate+"\\SSB\\"+file.getName()),
	   ...
	   public void ReadEW(){
		   File fileGS = new File("D:\\Raurkela("+UnitCode+")\\"+fileDate+"\\EW\\");
		   if(fileGS.exists()) {
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              ...
		              if(file.getName().trim().substring(0,3).contains("EWA")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Raurkela("+UnitCode+")\\"+fileDate+"\\EW\\"+file.getName()),
	   ...
	   public void ReadAS(){
		   File fileGS = new File("D:\\Raurkela("+UnitCode+")\\"+fileDate+"\\AS\\");
		   if(fileGS.exists()) {
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		   FMLDBTransactionCTDMSInvoices dbtB=new FMLDBTransactionCTDMSInvoices();
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              ...
		              if(file.getName().substring(0,2).contains("AA")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Raurkela("+UnitCode+")\\"+fileDate+"\\AS\\"+file.getName()),
	   ...
	   public void ReadFMS(){
		   File fileGS = new File("D:\\Raurkela("+UnitCode+")\\"+fileDate+"\\FMS\\");
		   if(fileGS.exists()) {
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		   ...
		   List<String>invL2=dbtB.getInvoiceNamePlanB(UnitCode,"FMS",yesterday);
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              System.out.println("Actual File Name: "+file.getName());
		              System.out.println("File path: "+file.getAbsolutePath());
		              if(file.getName().substring(0,1).contains("F") && file.getName().substring(3,5).contains("RO")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Raurkela("+UnitCode+")\\"+fileDate+"\\FMS\\"+file.getName()),
	   ...
	   public void ReadSW(){
		   File fileGS = new File("D:\\Raurkela("+UnitCode+")\\"+fileDate+"\\SW\\");
		   if(fileGS.exists()) {
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		   ...
		   List<String>invL2=dbtB.getInvoiceNamePlanB(UnitCode,"SW",yesterday);
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              System.out.println("Actual File Name: "+file.getName());
		              System.out.println("File path: "+file.getAbsolutePath());
		              if(file.getName().substring(2,4).contains("RO")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Raurkela("+UnitCode+")\\"+fileDate+"\\SW\\"+file.getName()),
