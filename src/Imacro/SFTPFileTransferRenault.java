...
import Imacro.UnitDTO;
public class SFTPFileTransferRenault {
    ...
    public static void main(String args[]) throws IOException {
 	   ...
 	   SFTPFileTransferRenault sftpFileTransfer=new SFTPFileTransferRenault();
					    ...
					    if(e.id == ChannelSftp.SSH_FX_NO_SUCH_FILE){
							...
							String[] s	=filepath.split("/");
								...
								String fname="";
								 ...
								 if(s[5].substring(0,2).contains("IN")) {
									fname=s[5].substring(0,16);
					    	     }else if(s[5].substring(0,2).contains("RO")) {
											fname=s[5].substring(0,16);
					    	     }else if(s[5].substring(0,2).contains("SE")) {
										fname=s[5].substring(0,16);
					    	     } else if(s[5].substring(0,3).contains("WIN")) {
										fname=s[5].substring(0,16);
					    	     }
					    	     else if(s[5].substring(1,3).contains("MC")) {
										fname=s[5].substring(0,16);
					    	     }
					    	     else{
