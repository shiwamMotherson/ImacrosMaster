...
public class AudikolkataSftp {
    ...
    public static void main(String args[]) throws IOException {
 	   ...
 	   File directoryPath = new File("D:\\AudikolkataServiceData");

 	   AudikolkataSftp sftpFileTransfer=new AudikolkataSftp();
    ...
    public void createRootDirectory(File directoryPath) {
        ...
        try {
            ...
            String filepath=rootdirectory.replace("D:\\AudikolkataServiceData", "");
    ...
    public void createChildDirectory(ChannelSftp channelSftp,File directoryPath) {
		...
		if(filesList!=null){	 
    	  for(File file : filesList) {
    		  if(file.isDirectory()) {
    			  String filepath=file.getAbsolutePath().replace("D:\\AudikolkataServiceData", "");
				    ...
				    try {
					    ...
					    if(e.id == ChannelSftp.SSH_FX_NO_SUCH_FILE){
							...
							if(fname.substring(0,7).equalsIgnoreCase("Vehicle")) {
								 File fileInD = new File("D:\\AudikolkataServiceData\\Vehicle Data Kolkata.xlsx");
							      
							        File rename = new File("D:\\AudikolkataServiceData\\"+imformat(yesterday1)+" "+"Vehicle Data Kolkata.xlsx");
