...
public class CuttuckFolderInvoiceReadingF01 {
	...
	static String UnitCode="F01";
	 public static void main(String args[]) throws IOException {
	  ...
	  sftpFileTransfer.createRootDirectory(directoryPath);
	   ...
	   public void ReadGS(){
		   File fileGS = new File("D:\\Cuttuck("+UnitCode+")\\"+fileDate+"\\GS\\");
		   if(fileGS.exists()) {
		   ...
		   if(!(dbt.checkCountLog1("GS", yesterday,UnitCode))){
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              ...
		              if(file.getName().substring(0,3).contains("TXY")) {
		              	...
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Cuttuck("+UnitCode+")\\"+fileDate+"\\GS\\"+file.getName()),
	   ...
	   public void ReadBP(){
		   File fileGS = new File("D:\\Cuttuck("+UnitCode+")\\"+fileDate+"\\BP\\");
		   if(fileGS.exists()) {
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              ...
		              if(file.getName().substring(0,3).contains("TXY")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Cuttuck("+UnitCode+")\\"+fileDate+"\\BP\\"+file.getName()),
	   ...
	   public void ReadBS(){
		   File fileGS = new File("D:\\Cuttuck("+UnitCode+")\\"+fileDate+"\\BS\\");
		   if(fileGS.exists()) {
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		   ...
		   List<String>invL2=dbtB.getInvoiceNamePlanB(UnitCode,"BS",yesterday);
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              System.out.println("Actual File Name: "+file.getName());
		              System.out.println("File path: "+file.getAbsolutePath());
		              if(file.getName().substring(0,3).contains("INY")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Cuttuck("+UnitCode+")\\"+fileDate+"\\BS\\"+file.getName()),
	   ...
	   public void ReadBSB(){
		   File fileGS1 = new File("D:\\Cuttuck("+UnitCode+")\\"+fileDate+"\\BSB\\");
		   if(fileGS1.exists()){
			   File fileGS = new File("D:\\Cuttuck("+UnitCode+")\\"+fileDate+"\\BSB\\");
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		    ...
		    try {
		      for(File file : filesList) {
		          if(file.isFile()) {
		              System.out.println("Actual File Name: "+file.getName());
		              System.out.println("File path: "+file.getAbsolutePath());
		              if(file.getName().substring(0,3).contains("BSY")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Cuttuck("+UnitCode+")\\"+fileDate+"\\BSB\\"+file.getName()),
	   ...
	   public void ReadSSB(){
		   File fileGS = new File("D:\\Cuttuck("+UnitCode+")\\"+fileDate+"\\SSB\\");
		   if(fileGS.exists()) {
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		   ...
		   System.out.println("------------------------------");
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              System.out.println("Actual File Name: "+file.getName());
		              System.out.println("File path: "+file.getAbsolutePath());
		              if(file.getName().substring(0,3).contains("SSY")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Cuttuck("+UnitCode+")\\"+fileDate+"\\SSB\\"+file.getName()),
	   ...
	   public void ReadEW(){
		   File fileGS = new File("D:\\Cuttuck("+UnitCode+")\\"+fileDate+"\\EW\\");
		   if(fileGS.exists()) {
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		   ...
		   List<String>invL2=dbtB.getInvoiceNamePlanB(UnitCode,"EW",yesterday);
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              System.out.println("Actual File Name: "+file.getName());
		              System.out.println("File path: "+file.getAbsolutePath());
		              if(file.getName().trim().substring(0,3).contains("EWY")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Cuttuck("+UnitCode+")\\"+fileDate+"\\EW\\"+file.getName()),
	   ...
	   public void ReadAS(){
		   File fileGS = new File("D:\\Cuttuck("+UnitCode+")\\"+fileDate+"\\AS\\");
		   if(fileGS.exists()) {
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		   ...
		   try {
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              System.out.println("Actual File Name: "+file.getName());
		              System.out.println("File path: "+file.getAbsolutePath());
		              if(file.getName().substring(0,2).contains("AY")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Cuttuck("+UnitCode+")\\"+fileDate+"\\AS\\"+file.getName()),
	   ...
	   public void ReadFMS(){
		   File fileGS = new File("D:\\Cuttuck("+UnitCode+")\\"+fileDate+"\\FMS\\");
		   if(fileGS.exists()) {
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		   ...
		   List<String>invL2=dbtB.getInvoiceNamePlanB(UnitCode,"FMS",yesterday);
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              System.out.println("Actual File Name: "+file.getName());
		              System.out.println("File path: "+file.getAbsolutePath());
		              if(file.getName().substring(0,1).contains("F") && file.getName().substring(3,5).contains("BH")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Cuttuck("+UnitCode+")\\"+fileDate+"\\FMS\\"+file.getName()),
	   ...
	   public void ReadSW(){
		   File fileGS = new File("D:\\Cuttuck("+UnitCode+")\\"+fileDate+"\\SW\\");
		   if(fileGS.exists()) {
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		   ...
		   List<String>invL2=dbtB.getInvoiceNamePlanB(UnitCode,"SW",yesterday);
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              System.out.println("Actual File Name: "+file.getName());
		              System.out.println("File path: "+file.getAbsolutePath());
		              if(file.getName().substring(2,4).contains("BH")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Cuttuck("+UnitCode+")\\"+fileDate+"\\SW\\"+file.getName()),
		              	    ...
		              	    dbt.updateStatus1(UnitCode,"SW",fname,yesterday,"Y");
		              	      ...
		              	      if(!(dbt.checkCountLog1("SW", yesterday,UnitCode))){
		              		   ...
		              		   if(totalCount<2 && totalCount!=0) { 
		              		      ...
		              		      DBTransactionCTDMSInvoices dbt1=new DBTransactionCTDMSInvoices();
		              		      dbt1.updateUploadFileCount1("F01","SW",yesterday);
		              		       }
		              	} catch (Exception e) {
		              		System.out.println ("File already exists in structured folder.\n-------------------------------------------------------");
		              	}
