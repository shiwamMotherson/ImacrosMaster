...
public class ETCTDMFolderReadAndUploadSftpE01 {
	...
	static String UnitCode="E01";
	 public static void main(String args[]) throws IOException {
		 ETCTDMFolderReadAndUploadSftpE01 ctdms= new ETCTDMFolderReadAndUploadSftpE01();
		 for(int i=0;i<=22;i++) {
	  ...
	  sftpFileTransfer.createRootDirectory(directoryPath);
	   ...
	   public void ReadGS(){
		   File fileGS = new File("D:\\Noida("+UnitCode+")\\"+fileDate+"\\GS\\");
		   if(fileGS.exists()) {
		   ...
		   if(!(dbt.checkCountLog1("GS", yesterday,UnitCode))){
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              ...
		              if(file.getName().substring(0,3).contains("TXB")) {
		              	...
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Noida("+UnitCode+")\\"+fileDate+"\\GS\\"+file.getName()),
	   ...
	   public void ReadBP(){
		   File fileGS = new File("D:\\Noida("+UnitCode+")\\"+fileDate+"\\BP\\");
		   if(fileGS.exists()) {
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              ...
		              if(file.getName().substring(0,3).contains("TXB")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Noida("+UnitCode+")\\"+fileDate+"\\BP\\"+file.getName()),
	   ...
	   public void ReadBS(){
		   File fileGS = new File("D:\\Noida("+UnitCode+")\\"+fileDate+"\\BS\\");
		   if(fileGS.exists()) {
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		   ...
		   List<String>invL2=dbtB.getInvoiceNamePlanB(UnitCode,"BS",yesterday);
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              System.out.println("Actual File Name: "+file.getName());
		              System.out.println("File path: "+file.getAbsolutePath());
		              if(file.getName().substring(0,3).contains("INB")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Noida("+UnitCode+")\\"+fileDate+"\\BS\\"+file.getName()),
	   ...
	   public void ReadBSB(){
		   File fileGS1 = new File("D:\\Noida("+UnitCode+")\\"+fileDate+"\\BSB\\");
		   if(fileGS1.exists()){
			   File fileGS = new File("D:\\Noida("+UnitCode+")\\"+fileDate+"\\BSB\\");
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		    ...
		    try {
		      for(File file : filesList) {
		          if(file.isFile()) {
		              System.out.println("Actual File Name: "+file.getName());
		              System.out.println("File path: "+file.getAbsolutePath());
		              if(file.getName().substring(0,3).contains("BSB")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Noida("+UnitCode+")\\"+fileDate+"\\BSB\\"+file.getName()),
	   ...
	   public void ReadSSB(){
		   File fileGS = new File("D:\\Noida("+UnitCode+")\\"+fileDate+"\\SSB\\");
		   if(fileGS.exists()) {
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              ...
		              if(file.getName().substring(0,3).contains("SSB")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Noida("+UnitCode+")\\"+fileDate+"\\SSB\\"+file.getName()),
	   ...
	   public void ReadEW(){
		   File fileGS = new File("D:\\Noida("+UnitCode+")\\"+fileDate+"\\EW\\");
		   if(fileGS.exists()) {
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		   ...
		   List<String>invL2=dbtB.getInvoiceNamePlanB(UnitCode,"EW",yesterday);
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              System.out.println("Actual File Name: "+file.getName());
		              System.out.println("File path: "+file.getAbsolutePath());
		              if(file.getName().trim().substring(0,3).contains("EWB")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Noida("+UnitCode+")\\"+fileDate+"\\EW\\"+file.getName()),
	   ...
	   public void ReadAS(){
		   File fileGS = new File("D:\\Noida("+UnitCode+")\\"+fileDate+"\\AS\\");
		   if(fileGS.exists()) {
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		   FMLDBTransactionCTDMSInvoices dbtB=new FMLDBTransactionCTDMSInvoices();
		   ...
		   try {
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              System.out.println("Actual File Name: "+file.getName());
		              System.out.println("File path: "+file.getAbsolutePath());
		              if(file.getName().substring(0,2).contains("AB")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Noida("+UnitCode+")\\"+fileDate+"\\AS\\"+file.getName()),
	   ...
	   public void ReadFMS(){
		   File fileGS = new File("D:\\Noida("+UnitCode+")\\"+fileDate+"\\FMS\\");
		   if(fileGS.exists()) {
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              ...
		              if(file.getName().substring(0,1).contains("F") && file.getName().substring(3,5).contains("NO")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Noida("+UnitCode+")\\"+fileDate+"\\FMS\\"+file.getName()),
	   ...
	   public void ReadSW(){
		   File fileGS = new File("D:\\Noida("+UnitCode+")\\"+fileDate+"\\SW\\");
		   if(fileGS.exists()) {
		   DBTransactionCTDMSInvoices dbt=new DBTransactionCTDMSInvoices();
		   ...
		   List<String>invL2=dbtB.getInvoiceNamePlanB(UnitCode,"SW",yesterday);
		      ...
		      for(File file : filesList) {
		          if(file.isFile()) {
		              System.out.println("Actual File Name: "+file.getName());
		              System.out.println("File path: "+file.getAbsolutePath());
		              if(file.getName().substring(2,4).contains("NO")) {
		              	...
		              	try {
		              	Path temp = Files.move
		              	        (Paths.get("D:\\Noida("+UnitCode+")\\"+fileDate+"\\SW\\"+file.getName()),
